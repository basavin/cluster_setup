...
ENV="JAVA_HOME=/usr/lib/jvm/java-1.7.0-openjdk-amd64 \
  ...
  SPARK_MASTER_IP=128.104.222.36\
  ...
  ZOOKEEPER_BIN_PATH=/home/ubuntu/software/zookeeper-${ZOOKEEPER_VERSION}/bin\
  STORM_BIN_PATH=/home/ubuntu/software/apache-storm-${STORM_VERSION}/bin"
...
export PATH=/home/ubuntu/software/hadoop-${COMMON_VERSION}/bin:/home/ubuntu/software/hadoop-${COMMON_VERSION}/sbin:$HIVE_HOME/bin:/home/ubuntu/software/spark-1.5.0-bin-hadoop2.6/bin:/home/ubuntu/software/spark-1.5.0-bin-hadoop2.6/sbin:/home/ubuntu/software/zookeeper-3.4.6/bin:/home/ubuntu/software/apache-storm-0.9.5/bin:/home/ubuntu/software/sbt/bin:$PATH
...
start_spark(){
	...
	pdsh -R exec -f $THREADS -w ^instances ssh -o ConnectTimeout=$TIMEOUT %h '( . /home/ubuntu/run.sh -q ; $SPARK_HOME/sbin/start-slave.sh spark://$SPARK_MASTER_IP:7077;)'
}
